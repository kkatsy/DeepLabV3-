...
class DeepLabV3PBlur(nn.Module):
    def __init__(self, n_class):
        super(DeepLabV3PBlur, self).__init__()
    ...
    def forward(self, input):
        ...
        aspp_pyramid = [aspp_conv1_output, aspp_conv3_r6_output, aspp_conv3_r12_output, aspp_conv3_r18_output,
                        aspp_pool_output]
